...
// */
//func zigZag(t *testing.T, infoChan <-chan common.Elevator, stopChan chan<- bool) {
//
...
//					stopChan <- true
//				}
//				common.ElevatorState.SetDirection(C.MotorUP)
//			case 1:
//				if info.GetFloor() != 1 {
...
//					stopChan <- true
//				}
//				common.ElevatorState.SetDirection(C.MotorDOWN)
//			}
//		case <-stuck.C:
